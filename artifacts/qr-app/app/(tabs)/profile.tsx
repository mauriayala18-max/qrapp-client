...
export default function ProfileScreen() {
  ...
  const menuItems: MenuItem[] = [
    { icon: "user", label: "Mis datos", onPress: () => {} },
    { icon: "credit-card", label: "Métodos de pago", onPress: () => {} },
    { icon: "heart", label: "Mis favoritos", onPress: () => {} },
    { icon: "award", label: "Puntos y recompensas", onPress: () => {} },
    { icon: "calendar", label: "Reservas", onPress: () => {} },
    { icon: "settings", label: "Configuración", onPress: () => {} },
    { icon: "help-circle", label: "Soporte", onPress: () => {} },
